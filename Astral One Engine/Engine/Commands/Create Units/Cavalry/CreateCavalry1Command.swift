...
public class CreateCavalry1Command: Command {
    public private(set) var cavalry: Cavalry1
    ...
    public init(db: Db,
        ...
        cavalry = Cavalry1(player: player,
                           theme: Theme(id: Constants.noId, name: "Standard"),
                           skin: db.skinDao.getSkin(unitType: UnitType.Cavalry1)
                           name: "Cavalry6-\(Int.random(in: 0..<500))",
                           position: city.position)
        
        currentDisplayText = "Ready to create cavalry unit named \(cavalry.name)."
        currentDebugText = "Ready to create Cavalry1 unit named \(cavalry.name) (\(cavalry.id))."
    ...
    public init(commandId: Int,
        ...
        cavalry = Cavalry1(player: player,
                           theme: Theme(id: Constants.noId, name: "Standard"),
                           name: "Cavalry1-\(Int.random(in: 0..<500))",
                           position: city.position)
