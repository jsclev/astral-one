...
public class CreateCavalry6Command: Command {
    public private(set) var cavalry: Cavalry6
    ...
    public init(db: Db,
        ...
        cavalry = Cavalry6(player: player,
    ...
    public init(commandId: Int,
        ...
        currentDisplayText = "Ready to create cavalry unit named \(cavalry.name)."
        currentDebugText = "Ready to create Cavalry6 unit named \(cavalry.name) (\(cavalry.id))."
