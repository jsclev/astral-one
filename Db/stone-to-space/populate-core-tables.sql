...
-- Unit types
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Infantry1', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Infantry2', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Infantry3', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Infantry4', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Infantry5', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Infantry6', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Infantry7', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Infantry8', 'Mechanized Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Cavalry1', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Cavalry2', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Cavalry3', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Cavalry4', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Cavalry5', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Cavalry6', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Cavalry7', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Cavalry8', 'Mechanized Tank', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Artillery1', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Artillery2', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Artillery3', 'Cannon', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Artillery4', 'Howitzer', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Air1', 'Bomber', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Air2', 'Fighter', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Air3', 'Stealth Bomber', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Air4', 'Stealth Fighter', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Air5', 'Helicopter', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Naval1', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Naval2', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Naval3', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Naval4', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Naval5', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Naval6', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Naval7', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Naval8', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Naval9', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'NavalTransport', 'Transport', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Submarine', 'Submarine', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'AircraftCarrier', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'CityCreator', 'MCV', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Explorer', 'Basic Infantry', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Marine', 'Marine', 1, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'ParaTrooper', 'ParaTrooper', 1, (select skin_id from skin where name = 'Standard'));

insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Air1', 'Bomber', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Air2', 'Fighter', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Air3', 'Stealth Bomber', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Air4', 'Stealth Fighter', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Air5', 'Helicopter', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'AircraftCarrier', 'Carrier', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'AlpineTroop', 'Alpine Troop', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Artillery1', 'Light Cannon', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Artillery2', 'Cannon', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Artillery3', 'Heavy Cannon', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Artillery4', 'Howitzer', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Cavalry1', 'Tank 1', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Cavalry2', 'Tank 2', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Cavalry3', 'Tank 3', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Cavalry4', 'Tank 4', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Cavalry5', 'Tank 5', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Cavalry6', 'Tank 6', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Cavalry7', 'Tank 7', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Cavalry8', 'Mechanized Tank', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'CityCreator', 'MCV', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Crusader', 'Crusader', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Diplomat', 'Diplomat', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Engineer', 'Engineer', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Explorer', 'Explorer Drone', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Fanatic', 'Fanatic', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Infantry1', 'Infantry 1', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Infantry2', 'Infantry 2', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Infantry3', 'Infantry 3', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Infantry4', 'Infantry 4', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Infantry5', 'Infantry 5', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Infantry6', 'Infantry 6', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Infantry7', 'Infantry 7', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Infantry8', 'Mechanized Infantry', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Marine', 'Marine', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Naval1', 'Ship 1', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Naval2', 'Ship 2', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Naval3', 'Ship 3', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Naval4', 'Ship 4', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Naval5', 'Ship 5', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Naval6', 'Ship 6', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Naval7', 'Ship 7', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Naval8', 'Ship 8', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Naval9', 'Ship 9', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'NavalTransport', 'Transport', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'ParaTrooper', 'ParaTrooper', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Partisan', 'Partisan', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Spy', 'Spy', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Submarine', 'Submarine', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Trade1', 'Caravan', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'Trade2', 'Freight', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'CruiseMissile', 'Cruise Missile', 2, (select skin_id from skin where name = 'Standard'));
insert into unit_type (tiled_id, name, display_name, theme_id, skin_id) values (-1, 'NuclearMissile', 'Nuclear Missile', 2, (select skin_id from skin where name = 'Standard'));
