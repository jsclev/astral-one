-- Themes
insert into theme (name, description, source) values ('Civilization II', 'Civilization II retro theme', 0);

-- Turns
insert into turn (theme_id, ordinal, year, display_text) values (
    (select theme_id from theme where name ='Civilization II'), 1, -4000, '4000 BC');
insert into turn (theme_id, ordinal, year, display_text) values (
    (select theme_id from theme where name ='Civilization II'), 2, -3980, '3980 BC');
insert into turn (theme_id, ordinal, year, display_text) values (
    (select theme_id from theme where name ='Civilization II'), 3, -3960, '3960 BC');
insert into turn (theme_id, ordinal, year, display_text) values (
    (select theme_id from theme where name ='Civilization II'), 4, -3940, '3940 BC');
insert into turn (theme_id, ordinal, year, display_text) values (
    (select theme_id from theme where name ='Civilization II'), 5, -3920, '3920 BC');
insert into turn (theme_id, ordinal, year, display_text) values (
    (select theme_id from theme where name ='Civilization II'), 6, -3900, '3900 BC');
insert into turn (theme_id, ordinal, year, display_text) values (
    (select theme_id from theme where name ='Civilization II'), 7, -3880, '3880 BC');
insert into turn (theme_id, ordinal, year, display_text) values (
    (select theme_id from theme where name ='Civilization II'), 8, -3860, '3860 BC');
