...
-- Turn 1: Build city
insert into unit values (1, 1, (select unit_type_id from unit_type where name = 'Settlers'));
...
insert into unit values (2, 1, (select unit_type_id from unit_type where name = 'Warriors'));
