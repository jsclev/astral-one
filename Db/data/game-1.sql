...
insert into game_building values (1, 1, 1, (select id from building where name = 'Barracks'));
insert into game_action values (2, 1, 1, 1, (select id from action where name = 'Build Building'), 2);
insert into game_building_action values (1, 2, 1);
