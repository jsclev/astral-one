-- Themes
insert into theme (name, description, source) values ('Standard', 'Official standard theme', 0);
insert into theme (name, description, source) values ('Sci-Fi', 'Official sci-fi theme', 0);
insert into theme (name, description, source) values ('Fantasy', 'Official fantasy theme', 0);
insert into theme (name, description, source) values ('World War II', 'Community WWII theme', 1);
